...
<p>本サービスに登録していただき誠にありがとうございます。</br>
このサービスは広島市立大学の学生が作成・運営しています。</br>
今後アップデートを断続的に行うことでユーザの声を聞き、機能を追加していく予定です。</br>
問い合わせ方法につきましては<a href="../contact.php">こちら</a>からお願いいたします。 
</p>
</div>
</div>
