...
<title>本サービスについて｜広島市立大学 履修確認一覧サービス</title>
...
<div class="hcu_main">
  <div class="news_unit">
<h4>GPA計算機能追加のお知らせ - 2020/9/17</h4>
</br></br>
<p><a href ="https://kazufolio.com/login/insert_subject.php">履修済科目確認ページ</a>にGPA計算機能を追加いたしました。</br>
つきまして、新しく時間割を設定する必要があります。</br>
既に履修済科目を登録して頂いていたユーザには御足労おかけしますが<a href="https://kazufolio.com/login/timetable_index.php">時間割登録ページ</a>で科目登録できますので、是非ご活用ください。</br>
</br></br>
ユーザ様からの新機能の提案などにつきましては<a href="../contact.php">こちら</a>からお問い合わせの程、よろしくお願いいたします。 
</p>
</div>
</div>
