...
<html>
<head>
<title>プロフィール情報変更確認｜広島市立大学 履修確認一覧サービス</title>
...
<p class="information">名前：<?php echo $username; ?></p>
<p class="information">メールアドレス：<?php echo $email; ?></p>
<p class="information">所属学部：<?php echo $facluty; ?></p>
<p class="information">所属学科・専攻：<?php echo $facluty_detail; ?></p>
<p class="information">入学年：<?php echo $enter_year; ?></p>
</br>
</div>
</div>
