...
if($facluty=="情報科学部" && $facluty_detail=="情報工学科" && $enter_year == "2020"){
  $query = "SELECT * FROM information_engineering_subject_2020";
  $result = $mysqli->query($query);
?>
<h2><?php echo $facluty_detail; ?>共通科目</h2>
  <table border="1">
    <tr>
      <th class="subject">科目名</th>
      <th class="subject">科目種類</th>
...
if($facluty=="情報科学部" && $facluty_detail=="情報工学科" && $enter_year == "2019"){
  $query = "SELECT * FROM information_engineering_subject_2019";
  $result = $mysqli->query($query);
?>
<h2><?php echo $facluty_detail; ?>共通科目</h2>
  <table border="1">
...
if($facluty=="情報科学部" && $facluty_detail=="情報工学科" && $enter_year == "2018"){
  $query = "SELECT * FROM information_engineering_subject_2018";
  $result = $mysqli->query($query);
?>
<h2><?php echo $facluty_detail; ?>共通科目</h2>
  <table border="1">
...
if($facluty=="情報科学部" && $facluty_detail=="情報工学科" && $enter_year == "2017"){
  $query = "SELECT * FROM information_engineering_subject_2017";
  $result = $mysqli->query($query);
?>
<h2><?php echo $facluty_detail; ?>共通科目</h2>
  <table border="1">
