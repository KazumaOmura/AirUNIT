...
if(isset($_POST['insert'])){
  ...
  // テーブルデータの全削除のSQL作成
  $sql = "DELETE FROM $username_timetable WHERE subject_year = 20201";
...
// データベースの切断
$result->close();
  header("Location: timetable-20201_all.php");
...
?>
    ...
    <option class="subject" value=", NULL, NULL, NULL, <?php echo $i; ?><?php echo $time_num; ?>, 20201"></option>
...
while ($row = $result->fetch_assoc()) {
  ...
  <option class="subject" value="<?php echo $subject_name; ?>, <?php echo $subject_type; ?>, <?php echo $subject_number; ?>, <?php echo $unit_type; ?>, <?php echo $i; ?><?php echo $time_num; ?>, 20201"><?php echo $subject_name; ?></option>
  <?php
}
?>
</p>
...
<select name='evaluation[]'>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '未選択'; ?>, 20201" <?php echo "$selected00" ?>></option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '複数科目'; ?>, 20201" <?php echo "$selected00" ?>>同名称科目</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '秀'; ?>, 20201" <?php echo "$selected01" ?>>秀</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '優'; ?>, 20201" <?php echo "$selected02" ?>>優</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '良'; ?>, 20201" <?php echo "$selected03" ?>>良</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '可'; ?>, 20201" <?php echo "$selected04" ?>>可</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '不可'; ?>, 20201" <?php echo "$selected05" ?>>不可</option>
  <option value="<?php echo $n; ?><?php echo $time_num_2; ?>, <?php echo '*不可'; ?>, 20201" <?php echo "$selected06" ?>>*不可</option>
  </select>
  </td>
