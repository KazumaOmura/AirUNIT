...
<html>
<head>
<title>プロフィール情報｜広島市立大学 履修確認一覧サービス</title>
...
<table border='1'>
<tr>
	<th class="subject">名前</td>
	<th class="subject">メールアドレス</td>
	<th class="subject">所属学部</td>
	<th class="subject">所属学科・専攻</td>
	<th class="subject">入学年</td>
</tr>
 
 
<tr> 
	<td class="subject"><?php echo $username; ?></td>
	<td class="subject"><?php echo $email; ?></td>
	<td class="subject"><?php echo $facluty; ?></td>
	<td class="subject"><?php echo $facluty_detail; ?></td>
	<td class="subject"><?php echo $enter_year; ?></td>
</tr>
...
<!-- <h3>プロフィール情報を確認</h3> -->
<h2><a href="updata2.php" class="btn-flat-border_white">プロフィール情報を変更</a></h2>
<h2><a href="delete.php" class="btn-flat-border_white">サービスから退会</a></h2>
